                    ...
                    <TableBody>
                        {rowsToDisplay.map((row, index) => (
                            ...
                            >
                                ...
                                <TableCell align="center">{row.urlTrailer}</TableCell>
                                <TableCell align="center">{row.id_author}</TableCell>
                                <TableCell align="center">{row.listCate}</TableCell>
                                <TableCell align="center">{row.listActor}</TableCell>
                                <TableCell align="center">{row.listCharacter}</TableCell>
                                <TableCell align="center">
                                    <Button
