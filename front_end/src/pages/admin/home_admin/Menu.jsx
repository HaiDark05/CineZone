    ...
    return (
        <div className='m-auto bg-gradient-to-r from-violet-500 to-fuchsia-500 p-5 max-md:w-full max-md:p-3 md:h-screen'>
            ...
            <div className={`max-md:${openMenu ? 'block' : 'hidden'}`}>
                ...
                <div className="flex items-center p-2 gap-2 bg-amber-300/75 rounded-lg mt-2 text-white transition duration-700 hover:bg-amber-600/95">
                    <FaRegUserCircle />
                    {openMenu && <h1>Profile</h1>}
                </div>
            </div>
        </div>
    );
